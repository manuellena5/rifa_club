...
**El comprobante se manda con un solo botón.** Si la venta tiene un teléfono válido, abre derecho el chat de esa persona. Si no lo tiene, WhatsApp abre igual con el mensaje ya escrito y el vendedor elige el contacto ahí adentro. Nunca queda una venta sin poder mandar su comprobante. El botón está en Mis ventas, en la confirmación al guardar, y al tocar cualquier número vendido en la grilla.
